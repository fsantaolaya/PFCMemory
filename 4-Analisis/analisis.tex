...
En todo momento se debe poder usar la app sin hacer ningún tipo de registro previo. Solamente algunas funcionalidades especificas necesitarán del mismo. Para ello los datos serán almacenados en el dispositivo, sin perjuicio de que puedan una vez registrado ser compartidos en 'la nube' y se carguen en varios dispositivos.\\*
	...
	\textbf{OBJ-004}	Se hará énfasis en que el registro proporciona grandes ventajas, a pesar de poder usarse sin el\\*
	...
	\textbf{Historia 11}	El usuario podrá añadir una rutina para ese día desde cualquiera de las vistas mensual/diaria\\*
	...
	\textbf{FRQ-031}	El usuario podrá añadir información importante respecto a ese medicamento\\*
	...
	\textbf{FRQ-034 A FRQ-049}	Lo mismo con personajes, síntomas, pruebas\\*
	
	\textbf{FRQ-050}	El usuario podrá acceder a recursos relacionados con el autocontrol y la meditación\\*
	
	\textbf{FRQ-051}	El usuario tendrá acceso a teléfonos de interés\\*
	...
	\textbf{FRQ-054}	La aplicación notificará al paciente a petición citas y rutinas\\*
	
	\textbf{FRQ-055}	Las listas serán ordenable según diferentes criterios\\*
	
	\textbf{FRQ-056}	La aplicación contendrá ajustes que faciliten su manejo al usuario\\*
	...
	\textbf{CU-012}	RUTINA - Borrado\\*
		...
		\begin{table}[H]
			...
			\begin{tabular}[t]{|p{3cm}|p{9.5cm}|}
				...
				\hline \textbf{Flujo alternativo} & \textbf{Partiendo de CU-005} Inserción de datos de la cita\\* 
				...
				& \textbf{Partiendo de CU-007} Edición de datos de la cita\\* 
				& 1.- Pulsamos el icono + de la sección de medicamentos\\*	
				& 2.- Seleccionamos la opción 'Nuevo medicamento'\\*
				& 3.- Completamos los datos pertinentes al medicamento\\*
				\hline \textbf{Postcondición} & El usuario ya posee el medicamento en la aplicación \\* 
				\hline \textbf{Comentarios}   & Los valores de la posología del medicamento y el nombre de la misma son obligatorios, en caso de no ser rellenados, la aplicación avisará con un mensaje de error y no se podrá guardar la misma.\\*
				\hline
			\end{tabular}
		...
		\begin{table}[H]
			...
			\begin{tabular}[t]{|p{3cm}|p{9.5cm}|}
				...
				\hline \textbf{Precondición} & Se quiere acceder a un medicamento existente en la aplicación\\* 
				\hline \textbf{Flujo normal} & 1.- Desplegamos el menú drawer \\* 
				& 2.- Pulsamos la opción MEDICAMENTO\\*	
				& 3.- Pulsamos sobre los tres puntos a la derecha del medicamento que queremos editar\\*	
				& 4.- Seleccionamos la opción editar\\*	
				\hline \textbf{Flujo alternativo} & \textbf{Partiendo de CU-005} \\* 
				& \textbf{Partiendo de CU-007} \\* 
		...
		\begin{table}[H]
			...
			\begin{tabular}[t]{|p{3cm}|p{9.5cm}|}
				...
				\hline \textbf{Precondición} & Se quiere modificar la informacion de un medicamento existente en la aplicación\\* 
				\hline \textbf{Flujo normal} & 1.- Desplegamos el menú drawer \\* 
				& 2.- Pulsamos la opción MEDICAMENTO\\*	
				& 3.- Pulsamos sobre los tres puntos a la derecha del medicamento que queremos editar\\*	
				& 4.- Seleccionamos la opción 'editar'\\*	
		...
		\begin{table}[H]
			...
			\begin{tabular}[t]{|p{3cm}|p{9.5cm}|}
				...
				& 4.- Seleccionamos la opción 'eliminar'\\*	
				\hline \textbf{Flujo alternativo} & No se contempla \\* 
				\hline \textbf{Postcondición} & El medicamento que se queria eliminar ya no existe en la aplicación \\* 
				\hline \textbf{Comentarios}   & \\*
				\hline
			\end{tabular}
		...
		\begin{table}[H]
			...
			\begin{tabular}[t]{|p{3cm}|p{9.5cm}|}
				...
				\hline \textbf{Flujo alternativo} & \textbf{Partiendo de CU-005} \\* 
				& \textbf{Partiendo de CU-007} \\*
				& \textbf{Partiendo de CU-009} \\* 
				& \textbf{Partiendo de CU-011} \\*
	...
	\begin{table}[H]
		...
		\begin{tabular}[t]{|p{3cm}|p{9.5cm}|}
			...
			\hline \textbf{Comentarios}   & Los valores de la fecha del síntoma y el nombre de la misma son obligatorios, en caso de no ser rellenados, la aplicación avisará con un mensaje de error y no se podrá guardar la misma.\\*
			\hline
		\end{tabular}
	...
	\begin{table}[H]
		...
		\begin{tabular}[t]{|p{3cm}|p{9.5cm}|}
			...
			\hline \textbf{Flujo alternativo} & No se contempla \\* 
			\hline \textbf{Postcondición} & El usuario ya posee los nuevos datos modificados del síntoma en la aplicación \\* 
			\hline \textbf{Comentarios}   & \\*
			\hline
		\end{tabular}
	...
	\begin{table}[H]
		...
		\begin{tabular}[t]{|p{3cm}|p{9.5cm}|}
			...
			\hline \textbf{Flujo alternativo} & No se contempla \\* 
			\hline \textbf{Postcondición} & El usuario ya posee los nuevos datos modificados del síntoma en la aplicación \\* 
			\hline \textbf{Comentarios}   & Los valores de la fecha del síntoma y el nombre de la misma son obligatorios, en caso de no ser completados, la aplicación avisará con un mensaje de error y no se podrá guardar la misma.\\*
			\hline
		\end{tabular}
